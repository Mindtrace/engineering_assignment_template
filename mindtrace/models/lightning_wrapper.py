...
class ClassificationLightningWrapper(pl.LightningModule):
    """Lightning wrapper for a classification model."""
    ...
    def _step(self, batch, step_type):
        ...
        self.log(
            ...
            self.accuracy_metrics[step_type](logits.to('cpu'), y.view(-1).to('cpu')),
            sync_dist=True,
            prog_bar=True,
        )
        return loss
