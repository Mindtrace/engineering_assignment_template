...
from mindtrace.services import register_connection_manager, Service
...
@register_connection_manager(GatewayConnectionManager)
class Gateway(Service):
    def __init__(self, **kwargs):
        ...
        self.add_endpoint("/register_app", func=self.register_app, methods=["POST"])
